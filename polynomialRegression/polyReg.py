...
X_train_confirmed, X_test_confirmed, y_train_confirmed, y_test_confirmed = train_test_split(day_initial, indonesiaCases, test_size=0.15, shuffle=False)
